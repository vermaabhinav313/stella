...
from stella import dispatcher, DEL_CMDS, WHITELIST_USERS, SUPPORT_USERS, SUDO_USERS, DEV_USERS
...
def sudo_plus(func):
    ...
    def is_sudo_plus_func(bot: Bot, update: Update, *args, **kwargs):
        ...
        if user and is_sudo_plus(chat, user.id):
            ...
            update.effective_message.reply_text("You aren't an admin.")
...
from stella.modules import connection
