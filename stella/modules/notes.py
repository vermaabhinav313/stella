...
import stella.modules.sql.notes_sql as sql
from stella import dispatcher, MESSAGE_DUMP, LOGGER
from stella.modules.disable import DisableAbleCommandHandler
from stella.modules.helper_funcs.chat_status import user_admin
from stella.modules.helper_funcs.misc import build_keyboard, revert_buttons
from stella.modules.helper_funcs.msg_types import get_note_type
            ...
            try:
                ...
                if excp.message == "Entity_mention_user_invalid":
                    ...
                    message.reply_text("This note could not be sent, as it is incorrectly formatted. Ask in "
                                       "@stellabot if you can't figure out why!")
