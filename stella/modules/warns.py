...
from stella import dispatcher, BAN_STICKER
from stella.modules.disable import DisableAbleCommandHandler
from stella.modules.helper_funcs.chat_status import (is_user_admin, bot_admin, user_admin_no_reply, user_admin,
                                                     can_restrict)
from stella.modules.helper_funcs.extraction import extract_text, extract_user_and_text, extract_user
from stella.modules.helper_funcs.filters import CustomFilters
from stella.modules.helper_funcs.misc import split_message
from stella.modules.helper_funcs.string_handling import split_quotes
from stella.modules.log_channel import loggable
from stella.modules.sql import warns_sql as sql
...
def button(bot: Bot, update: Update) -> str:
    ...
    if match:
        ...
        if res:
            ...
            update.effective_message.edit_text(f"This user has already has no warns.", parse_mode=ParseMode.HTML)
