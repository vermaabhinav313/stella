...
import stella.modules.sql.global_mutes_sql as sql
from stella import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, STRICT_GMUTE
from stella.modules.helper_funcs.chat_status import user_admin, is_user_admin
...
def __user_info__(user_id):
    ...
    text = ""
    if is_gmuted:
        text += "<b>This person is Globally muted</b>"
